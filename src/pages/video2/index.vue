    ...
    <div class="content" style="display: flex;flex-direction: column;">
      ...
      <view style="flex: 1;position: fixed;height: 65vh;width: 100%;bottom: 0;">
        <scroll-view scroll-y="true" style="height: 100%;">
          ...
          <div @tap="fileClick" style="display: flex;flex-direction: column;padding: 10px;background-color: #fff;">
            <!--items-->
            <div style="display: flex; align-items: center">
              <div class="card-2" style="margin-right: 10px">
                <image :src="sDetail?sDetail.doubanInfo.Image:''"
                       style="width: 80px;height: 110px"></image>
              </div>
              <div style="flex: 1;display: flex;flex-direction: column;">

                <div style="display: flex;align-items: center">
                  <text style="font-size: 18px;color: #000;font-weight: bold;margin-bottom: 5px;">
                    {{sDetail?sDetail.doubanInfo.Title:''}}
                  </text>

                  <div style="flex: 1;"></div>

                  <div style="display: flex;align-items: center;align-self:baseline;">
                    <image src="/static/images/td.png" style="width: 16px;height: 16px;margin-right: 5px"></image>
                    <image src="/static/images/yk.jpg" style="width: 16px;height: 16px;margin-right: 5px"></image>
                    <image src="/static/images/mgtv.png" style="width: 16px;height: 16px;margin-right: 5px"></image>
                    <image src="/static/images/aqy.png" style="width: 16px;height: 16px;margin-right: 5px"></image>
                    <image src="/static/images/tx.png" style="width: 16px;height: 16px;margin-right: 5px"></image>
                  </div>
                </div>


                <text style="font-size: 12px;color: #666;margin-bottom: 5px">{{sDetail?sDetail.doubanInfo.Author:''}}</text>
                <text class="description">{{sDetail?sDetail.doubanInfo.Summary:''}}</text>
              </div>
            </div>
            <!--/items-->
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      recommendClick: function(item) {
        ...
        that.sDetail = item;
        wx.setStorageSync("ITEMDETAIL2", JSON.stringify(item));
        that.getData();
      },
      addGood: function() {
        var that = this;
