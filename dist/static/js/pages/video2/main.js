...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": _vm.sDetail ? _vm.sDetail.doubanInfo.Image : ''
    }
  })]), _vm._v(" "), _c('div', {
    staticStyle: {
      "flex": "1",
  ...
  }, [_vm._v(_vm._s(_vm.sDetail ? _vm.sDetail.doubanInfo.Author : ''))]), _vm._v(" "), _c('text', {
    staticClass: "description"
  }, [_vm._v(_vm._s(_vm.sDetail ? _vm.sDetail.doubanInfo.Summary : ''))])])])]), _vm._v(" "), _c('div', {
    staticStyle: {
      "height": "1px",
      "background-color": "#eee"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6ad70e14", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_6ad70e14_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(100);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-6ad70e14"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_6ad70e14_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/pages/video2/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6ad70e14", Component.options)
  } else {
    hotAPI.reload("data-v-6ad70e14", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  onShareAppMessage: function onShareAppMessage(res) {
    return {
      title: "",
      path: "/pages/video2/main?vpid=" + this.vpid
    };
  },
  ...
  methods: {
    fileClick: function fileClick() {
      ...
      //单选
      wx.showActionSheet({
        itemList: ['土豆视频', '优酷视频', '芒果TV视频', '爱奇艺视频', '腾讯视频'],
        success: function success(res) {
          console.log(res.tapIndex);
          if (res.tapIndex === 0) {
            that.copy('http://www.soku.com/nt/search/q_' + that.sDetail.doubanInfo.Title);
          } else if (res.tapIndex === 1) {
            that.copy('http://so.youku.com/search_video/q_' + that.sDetail.doubanInfo.Title);
          } else if (res.tapIndex === 2) {
            that.copy('https://so.mgtv.com/so/k-' + that.sDetail.doubanInfo.Title);
          } else if (res.tapIndex === 3) {
            that.copy('http://so.iqiyi.com/so/q_' + that.sDetail.doubanInfo.Title);
          } else {
            that.copy('https://v.qq.com/x/search/?q=' + that.sDetail.doubanInfo.Title);
          }
        },
        ...
        success: function success(res) {
          ...
          setTimeout(function () {
            wx.showModal({
              ...
              confirmColor: '#ff4f4d',
              confirmText: '行吧',
              content: "暂不支持直接播放,已为您复制好了,请粘贴到浏览器查看~",
              success: function success(res) {
                if (res.confirm) {
                  console.log("确定");
                } else if (res.cancel) {
