...
<script>
  export default {
    ...
    data() {
      return {
        types: ["sk-wandering-cubes", "sk-rotating-plane", "sk-double-bounce",
        "sk-wave","sk-three-bounce","sk-circle","sk-cube-grid","sk-folding-cube"]
        //animation
      };
    },
    methods: {},
